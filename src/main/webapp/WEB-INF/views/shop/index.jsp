...
<%@ include file="../shop_inc/cart.jsp" %>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(/resources/images/perfume_2.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
								<span class="ltext-101 cl2 respon2">
									Lovely Collection 2022
								</span>
							</div>
				...
				<div class="item-slick1" style="background-image: url(/resources/images/perfume_3.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div class="item-slick1" style="background-image: url(/resources/images/perfume_1.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="/resources/funfume/images/banner-01.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="/resources/funfume/images/banner-02.jpg" alt="IMG-BANNER">
